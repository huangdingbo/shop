...
<!--    <img src="--><?//=\Yii::getAlias('@web')?><!--/images/banners/banner-gamer.jpg" alt="">-->
    <div class="container">
...
<?php endforeach; ?>
    ...
    <div class="dropdown-banner-holder">
        <a href="#"><img alt="" src="<?=\Yii::getAlias('@web');?>/images/banners/banner-side.png" /></a>
    </div>
</div>
<!-- ================================== MEGAMENU VERTICAL ================================== -->
                    </li>
...
<!--        <div class="item" style="background-image: url(../../web/images/sliders/slider01.jpg');">-->
		<div class="item" style="background-image: url(../../../shop/web/images/sliders/slider01.jpg);">
		...
		<div class="item" style="background-image: url(../../../shop/web/images/sliders/slider02.jpg);">
			<div class="container-fluid">
				<div class="caption vertical-center text-left" style="color: #fff">
					<div class="big-text fadeInDown-1">
...
<!--            <a href="category-grid.html">-->
                ...
                <img class="banner-image" alt="" src="<?=\Yii::getAlias('@web');?>/images/blank.gif" data-echo="<?=\Yii::getAlias('@web');?>/images/banners/banner-narrow-01.jpg" />
<!--            </a>-->
        </div>
...
<!--            <a href="category-grid.html">-->
                ...
                <img class="banner-image" alt="" src="<?=\Yii::getAlias('@web');?>/images/blank.gif" data-echo="<?=\Yii::getAlias('@web');?>/images/banners/banner-narrow-02.jpg" />
<!--            </a>-->
        </div>
    </div><!-- /.container -->
                    ...
                    <?php foreach ($data['tui'] as $pro): ?>
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                <img width="220" height="220" alt="<?php echo $pro->title ?>" src="<?php echo $pro->cover ?>" data-echo="<?php echo $pro->cover ?>" />
                                </div>
                                <div class="body">
                                    <div class="title">
            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                            <img width="220" height="220"  alt="<?php echo $data['all'][$i]->title ?>" src="<?php echo $data['all'][$i]->cover ?>" data-echo="<?php echo $data['all'][$i]->cover ?>" />
                            </div>
                            <div class="body">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        ...
                        <img alt="<?php echo $last->title ?>" src="<?php echo $last->cover ?>" data-echo="<?php echo $last->cover ?>" />
                            </a>
                        ...
                        <div class="single-product-gallery-item" id="slide<?php echo $key+2; ?>">
                            <a data-rel="prettyphoto" href="<?php echo $last->pics ?>">
                                <img alt="" src="<?php echo $pic ?>" data-echo="<?php echo $pic ?>-picbig" />
                            </a>
                        </div><!-- /.single-product-gallery-item -->
                        <?php endforeach; ?>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                        <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="<?php echo $last->title ?>" src="<?php echo $last->cover ?>" data-echo="<?php echo $last->cover ?>" /></a></li>
                        <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key+1; ?>" href="#slide<?php echo $key+2; ?>"><img alt="" src="<?php echo $pic ?>" data-echo="<?php echo $pic ?>" /></a></li>
                        <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?=\Yii::getAlias('@web');?>/images/brands/brand-01.jpg" />
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?=\Yii::getAlias('@web');?>/images/brands/brand-02.jpg" />
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?=\Yii::getAlias('@web');?>/images/brands/brand-03.jpg" />
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?=\Yii::getAlias('@web');?>/images/brands/brand-04.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
