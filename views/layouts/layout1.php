...
<a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">
		<img alt="logo" src="<?=\Yii::getAlias('@web');?>/images/logo.png" width="233" height="54"/>
	</a>
</div><!-- /.logo -->
...
<div class="contact-info">
    <div class="footer-logo">
		<img alt="logo" src="http://pp9uv6lb0.bkt.clouddn.com/5ca1c53231c02" width="233" height="54"/>
    </div><!-- /.footer-logo -->
