...
<a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">
		<img alt="logo" src="<?=\Yii::getAlias('@web');?>/images/logo.png" width="300" height="50"/>
	</a>
</div><!-- /.logo -->
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <span class="count"><?php echo count($this->params['cart']['products']) ?></span>
                    <img src="<?=\Yii::getAlias('@web');?>/images/icon-cart.png" alt="" />
                </div>
...
<div class="contact-info">
    <div class="footer-logo">
		<img alt="logo" src="http://pp9uv6lb0.bkt.clouddn.com/5cadced504766" width="233" height="54"/>
    </div><!-- /.footer-logo -->
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="<?=\Yii::getAlias('@web');?>/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="<?=\Yii::getAlias('@web');?>/images/payments/payment-master.png"></li>
                        <li><img alt="" src="<?=\Yii::getAlias('@web');?>/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="<?=\Yii::getAlias('@web');?>/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
